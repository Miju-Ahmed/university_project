...
SECRET_KEY = 'django-insecure-e51x0v&9^q^&4698*=a2k+_g#stpbt+9m7-ruln9l94$dn&^v2'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'university_db_mysql',
        'USER': 'university_user_mysql',
        'PASSWORD': 'Miju', # The password you set in the MariaDB shell
        'HOST': 'localhost',
        'PORT': '3306',
        'OPTIONS': {
